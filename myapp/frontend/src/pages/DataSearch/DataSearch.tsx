                        ...
                        <Tabs.TabPane tab={`${'新查询'} ${index + 1}`} key={pane.tabId} closable={index !== 0}>
                            <div className="d-f fd-c h100">
                                ...
                                <div className="ov-h" id="showBox" style={{ height: 500 }}>
                                    ...
                                    <div className="page-content-card d-f ac jc-b">
                                        ...
                                        <div className="d-f ac datasearch-config-actions">
                                            <ConfigFormData
                                            ...
                                            <Button type="primary" loading={editorStore[activeKey].status === 'running'} onClick={() => {
                                    ...
                                    <div className="flex1 page-content-card p-r ov-a" style={{ height: 'calc(100% - 80px)' }}>
                                        <div>
