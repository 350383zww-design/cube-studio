...
export default function TaskListManager(props?: IAppMenuItem) {
  ...
  return (
    <div className="fade-in h100 d-f fd-c">
      ...
      <Content
        className={`appmgmt-content bg-title h100 d-f fd-c${
          filterParams.length ? "" : " ptb16"
        }`}
        style={filterParams.length ? undefined : { gap: 16 }}
      >
        {!!filterParams.length && (
          <div className="mlr16 mb16">
            <MixSearch
              values={filterValues}
              params={filterParams}
              onChange={(values) => {
        ...
        {isEchartShow ? (
          <div className="mlr16 mb16 page-content-card">
            <ChartOptionTempalte url={baseUrl} />
          </div>
        ) : null}
        ...
        {list_ui_type !== "card" ? (
          ...
          <div className="mlr16 mb16 flex1 page-content-card">
            {/*{*/}
